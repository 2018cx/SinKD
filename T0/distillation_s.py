...
def main():
    ...
    tmodel = AutoModelForSeq2SeqLM.from_pretrained(model_namet)
    ...
    for epoch in range(1, 11):
        ...
        for batch in eval_dataloader:
            ...
            with torch.no_grad():
                logits = tmodel(**model_inputs).logits
        ...
        if score>maxscore:
            maxscore=score
            #tmodel.save_pretrained(os.path.join('/youtu_pedestrian_detection/xiaocui/student',args.dataset_config_name))
